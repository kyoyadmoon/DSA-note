    ...
    <div className="rounded-xl border border-border bg-surface px-5 py-4 flex flex-col gap-3.5">
      <div className="flex items-center gap-3.5">
        ...
        <button
          ...
          className="flex items-center justify-center h-12 w-12 rounded-full bg-accent text-background hover:opacity-90 transition-opacity shadow-lg shadow-accent/20"
        ...
        <div className="mx-3 font-mono text-sm text-muted tabular-nums shrink-0">
          ...
          <div className="flex items-center gap-1 text-sm">
            ...
            {SPEEDS.map((s) => (
              <button
                ...
                className={
                  "px-2.5 py-1.5 rounded-md font-mono tabular-nums transition-colors " +
                  (speed === s
...
function IconButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      disabled={disabled}
      className="flex items-center justify-center h-10 w-10 rounded-md text-foreground/70 hover:text-foreground hover:bg-surface-raised disabled:opacity-30 disabled:pointer-events-none transition-colors"
    >
      {children}
    </button>
  );
